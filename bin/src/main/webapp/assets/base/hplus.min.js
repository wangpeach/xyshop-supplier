            ...
            $.ajax({
                ...
                success: function(data) {
                    for (var int = 0; int < data.length; int++) {
                        if (data[int]["menuUrl"] == '#') {
                            $("#" + data[int]["pId"]).append(
                                '<li><a href="' + data[int]["menuUrl"] + '"><i class="fa ' + data[int]["className"] + ' fa-fw"></i><span class="nav-label">' + data[int]["menuName"] + '</span><span class="fa arrow"></span></a>' + '<ul class="nav nav-second-level" id="' + data[int]["id"] + '"></ul>' + '</li>');
                        } else {
                            $("#" + data[int]["pId"]).append('<li><a class="J_menuItem" href="' + data[int]["menuUrl"] + '"><i class="fa ' + data[int]["className"] + ' fa-fw"></i><span class="nav-label">' + data[int]["menuName"] + '</span></a> </li>');
                        }
                    }
                }
            });
