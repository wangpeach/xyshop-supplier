...
<head>
	<base href="<%=basePath%>">
    <title>XXXX店铺管理后台 - 产品销售额月报表</title>
    ...
    <div class="wrapper wrapper-content">
        <div class="row">
            ...
            <div id="order-toolbar" class="btn-group">
             	<label>产品销售额月报表</label>
             	<select class="form-control js-change-table-params" id="js-choise-day" style="width: 250px;display: inline-block;">
             		<option value="month" selected="selected">本月数据统计</option>
             		<option value="pointMonth"><span id="js-appoint-time">指定月份</span></option>
  ...
  <div class="modal fade" id="timeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
   <div class="modal-dialog"> 
    <div class="modal-content"> 
     ...
     <div class="modal-body" id="orderInfo">
     	指定月份：<input class="form-control layer-date " style="width: 150px;vertical-align: baseline;"   id="js-date-begin" placeholder="开始时间">
     </div> 
     <div class="modal-footer"> 
...
<script>seajs.use("report/buyProfitMonthReportList");</script>
</body>
</html>
